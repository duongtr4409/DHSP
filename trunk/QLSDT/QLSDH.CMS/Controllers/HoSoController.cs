    ...
    public class HoSoController : Controller
    {
        ...
        public async System.Threading.Tasks.Task<ActionResult> CapNhatHoSoCaNhan(FormCollection form)
        {
            try
            {
                ...
                string Truong_TN_VB2 = form["tentruongct"] != null ? form["tentruongct"] : "";
                int Nam_TN_VB2 = form["namtn"] != null ? int.Parse(form["namtn"]) : 0;
                string HeDaoTao_VB2 = form["hedt"] != null ? form["hedt"] : "";
                string Nghanh_TN_VB2 = form["nganhtn"] != null ? form["nganhtn"] : "";
                string DiemTrungBinh_VB2 = form["diemTb"] != null ? form["diemTb"] : "";
                string LoaiTotNghiep_VB2 = form["loaitn"] != null ? form["loaitn"] : "";
