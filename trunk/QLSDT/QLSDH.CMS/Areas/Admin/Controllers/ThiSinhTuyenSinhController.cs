...
namespace TEMIS.CMS.Areas.Admin.Controllers
{
    ...
    public class ThiSinhTuyenSinhController : Controller
    {
        ...
        public async System.Threading.Tasks.Task<JsonResult> LoadGiangVienByKhoa(int khoaid, int? id_NHD = -1)
        {
            string str = "";
            try
            {
        ...
        public async Task<ActionResult> ThemMoiTS(FormCollection form)
        {
            try
            {
                ...
                DateTime NgaySinh = form["ngaysinh"] != null ? DateTime.Parse(form["ngaysinh"]) : DateTime.Now;
